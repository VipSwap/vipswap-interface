...
import { useVipCallback } from '../../state/vipswap/hooks'
import { useUserInvited } from '../../hooks/useVipSwap'
...
export default function AddressInviteModal({
  ...
  const { inviteCallback } = useVipCallback(typed)
      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="flex-start">
            <TYPE.main color={'#EA9F10'} fontWeight={500}>
            ...
            <RowBetween>
              ...
              <ButtonPrimary
                disabled={
                  !isAddress(typed ?? '') || myInvited !== ZERO_ADDRESS || ZERO_ADDRESS === invited || typed === account
                }
                margin="0 auto"
                padding="16px 16px"
                width="180px"
