...
const SwapTitle = styled.div`
  ...
  font-size: 20px;
  line-height: 1.2;
  padding: 0.75rem 50px 0;
  font-weight: 500;
  ${({ theme }) => theme.mediaWidth.upToSmall`
      padding: 0.75rem 1rem 0 1rem;
    `};
`
const ArrowDownColumn = styled.div`
  width: 10%;
  height: 100%;
  float: left;
  display: flex;
...
const ArrowDownIcon = styled.div`
  ...
  width: 12px;
  height: 12px;
  border-top: 2px solid #120902;
  border-right: 2px solid #120902;
...
`
const SwapContentRow = styled.div`
  position: relative;
  padding: 20px 50px;
  ${({ theme }) => theme.mediaWidth.upToSmall`
    padding: 0.75rem 1rem 0 1rem;
